...
def get_opts():
    ...
    parser.add_argument('--save_dir', type=str,
                        default='./logs',
                        help='save directory of logs')
    parser.add_argument('--root_dir', type=str,
                        default='/home/yyf/Workspace/NeRF/datasets/nerf_synthetic/ficus',
                        help='root directory of dataset')
    parser.add_argument('--exp_name', type=str, default='ficus',
    ...
    parser.add_argument('--num_gpus', type=int, nargs='+', default=[0],
                        help='serial number of gpu')
    ...
    parser.add_argument('--no_mask', action='store_false',
                        help='Whether the mask file exists')
    parser.add_argument('--sample_num', type=int, default=1,
                        help='Sample multiple of the picture')
